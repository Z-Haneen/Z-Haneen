...
<table>
  <tr>
    ...
    <td align="center" width="25%"><b>Networking & Security</b></td>
  ...
  <tr>
    ...
    <td valign="top">
      <img src="https://img.shields.io/badge/CCNA-🔥-blue?style=flat-square"/><br/>
      <img src="https://img.shields.io/badge/OSPF_%26_VLANs-⚡-orange?style=flat-square"/><br/>
      <img src="https://img.shields.io/badge/IPsec_VPN-🛡️-red?style=flat-square"/><br/>
      <img src="https://img.shields.io/badge/Firewalls-🔒-darkgreen?style=flat-square"/>
    </td>
    <td valign="top">
...
*   **🛍️ LaRoze Project | Full-Stack E-Commerce**
    *   Built using ASP.NET MVC, Entity Framework Core, and SQL Server.
    *   Features full authentication, shopping cart, and a highly scalable relational schema (+8 tables).
*   **🌐 CCNA Labs | Enterprise Network Topologies**
    *   Designed complex multi-site network topologies in Cisco Packet Tracer.
    *   Implemented OSPF (MD5), 10+ VLANs, Zone-Based Firewalls, and secured IPsec VPN tunnels.
*   **⚡ MoveOn | Responsive Web Ecosystem**
    *   A high-performance multi-page UI built using HTML5, CSS3, Bootstrap, and JavaScript.

---

### 💼 Professional Experience (Internships)

*   🛡️ **Network Security Intern** @ National Telecommunication Institute (NTI) *(Sep 2025 - Present)*
*   ⚙️ **Full Stack .NET Developer Intern** @ DEPI *(Oct 2024 - Apr 2025)*
*   🔌 **CCNA Technical Intern** @ Egyptian Engineers Syndicate *(Jul 2025 - Aug 2025)*
